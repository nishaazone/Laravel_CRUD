          ...
          <div class="card mt-5 p-3"> 
            ...
            <form method="POST" action="/products/manage/store" enctype="multipart/form-data">
              ...
              <div class="form-group">
                 <label>Product</label>
                  <input type="text" name="product_name" placeholder="Product" class="form-control" value="{{ old('product_name') }}"/>
              ...
              <div class="form-group">
                ...
                <select name="cateogory" id="cateogory" class="form-control">
                    ...
                    <option value="Manufactured Goods"  {{ old('cateogory') === "Manufactured Goods" ? 'selected' : '' }}>Manufactured Goods</option>
                    <option value="Purchased Goods And Services"  {{ old('cateogory') === "Purchased Goods And Services" ? 'selected' : '' }}>Purchased Goods And Services</option>  
                </select>
