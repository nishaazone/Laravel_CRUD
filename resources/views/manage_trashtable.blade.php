...
<body>
    ...
    <nav class="navbar navbar-dark bg-success">     
        <a class="nav-link text-light navbar-brand" href="{{ route('tableManage') }}">Manage > Products > Trash</a>   
    ...
    <table class="table table-hover mt-4">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                {{-- <a href="/forcedelete/{{ $manage->id }}" class="btn btn-danger btn-sm">Delete</a> --}}
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="/forcedelete/{{ $item->id }}" class="btn btn-danger btn-sm">Confirm Delete</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <td>
                <a href="/restore/{{ $item->id }}" class="btn btn-primary btn-sm">Restore</a>
              </td>
          </tr>
          @endforeach
        </tbody>
