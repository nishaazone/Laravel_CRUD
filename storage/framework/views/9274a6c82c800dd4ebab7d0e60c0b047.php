...
<body>
    ...
    <nav class="navbar navbar-dark bg-success">     
        <a class="nav-link text-light navbar-brand" href="<?php echo e(route('tableTrack')); ?>">Track > Products > Trash</a>   
  ...
  <div class="container">
    ...
    <table class="table table-hover mt-4">
        ...
        <tbody>
          ...
          <tr>
            <td><a href="#" class="link-dark"><?php echo e($track->id); ?></td>
            ...
            <td>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <a href="/trash/forcedelete/<?php echo e($track->id); ?>" class="btn btn-danger btn-sm">Confirm Delete</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <td>
                <a href="/track/restore/<?php echo e($track->id); ?>" class="btn btn-primary btn-sm">Restore</a>
              </td>
          </tr>
...
<?php /**PATH D:\Laravel\Task_1\resources\views/track_trashtable.blade.php ENDPATH**/ ?>