      ...
      <div class="row justify-content-center">
        <div class="col-sm-8">
          <div class="card mt-4 p-3"> 
            ...
            <form method="POST" action="<?php echo e(route('billPost')); ?>" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>     
              ...
              <div class="form-group">
                ...
                <select name="component_name" id="component_name" class="form-control">
                  <option value="">Select Component</option>
                    ...
                    <option value="<?php echo e($column->product_name); ?>"  <?php if(old('component_name') ==  $column->product_name): ?> selected <?php endif; ?>><?php echo e($column->product_name); ?></option>
              ...
              <div class="form-group">
                ...
                <input type="text" name="part_number" id="part_number" class="form-control" placeholder="Part Number" value="<?php echo e(old('part_number')); ?>"/>
             ...
             <div class="form-group">
                <label>Description</label>
                 <input type="text" name="description" placeholder="Enter Description" id="description" class="form-control" value="<?php echo e(old('description')); ?>"/>
             ...
             <div class="form-group">
                <label>Quantity Per Unit</label>
                 <input type="text" name="quantity_per_unit"  id="quantity_per_unit" placeholder="Enter Quantity Per Unit" class="form-control" value="<?php echo e(old('quantity_per_unit')); ?>"/>
             ...
             <div class="form-group">
                ...
                <input type="text" name="quantity_purchased" id="quantity_purchased" class="form-control" placeholder="Enter Quantity Purchased" value="<?php echo e(old('quantity_purchased')); ?>"/>
             ...
             <div class="form-group">
                ...
                <input type="text" name="quantity" id="quantity" class="form-control" placeholder="Enter Quantity" value="<?php echo e(old('quantity')); ?>"/>
             ...
             <div class="form-group">
                ...
                <select name="source" id="source" class="form-control" >
                    ...
                    <option value="Internal" <?php echo e(old('source') === "Internal" ? 'selected' : ''); ?>>Internal</option>
                    <option value="External" <?php echo e(old('source') === "External" ? 'selected' : ''); ?>>External</option>
                </select>
             ...
             <div class="form-group">
                ...
                <select name="supplier" id="supplier" class="form-control" >
                    ...
                    <option value="PolyolProducers Inc" <?php echo e(old('supplier') === "PolyolProducers Inc" ? 'selected' : ''); ?>>PolyolProducers Inc</option>
                    <option value="DiisoChem Ltd" <?php echo e(old('supplier') === "DiisoChem Ltd" ? 'selected' : ''); ?>>DiisoChem Ltd</option>
                    <option value="CatFast Solutions" <?php echo e(old('supplier') === "CatFast Solutions" ? 'selected' : ''); ?>>CatFast Solutions</option>
                </select>
             ...
             <input type="hidden" name="track_id" value="<?php echo e($track->id); ?>">
              ...
              <div class="mt-3">
                ...
                <a href ="<?php echo e(route('billTable', $track->id )); ?>">
...
<?php /**PATH D:\Laravel\Task_1\resources\views/billMaterial.blade.php ENDPATH**/ ?>